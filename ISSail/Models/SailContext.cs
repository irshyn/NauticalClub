    ...
    public partial class SailContext : DbContext
    {
        ...
        public static SailContext Context
        {
            get
            {
                ...
                return new SailContext(optionsBuilder.Options);
            }
        }
...
//                optionsBuilder.UseSqlServer("Data Source=(localdb)\\mssqllocaldb;Initial Catalog=Sail;Integrated Security=True");
//            }
//        }
